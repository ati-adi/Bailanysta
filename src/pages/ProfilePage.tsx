...
import { CloudOff, Image, MapPin, Smile, SquarePen } from 'lucide-react'
...
export default function ProfilePage() {
  const { posts, postsLoading, postsError, refetchPosts, currentUser, pushToast, removePost } = useApp()
